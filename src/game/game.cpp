...
namespace game {
    Game::Game() {
        ...
        apartments[0]->getRooms()[1]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Sink",300,75,1,1,furniture::Utility::utilityType::hygiene)),point::Point(0,8));
        ...
        apartments[0]->getRooms()[1]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Bathtub",350,75,1,2,furniture::Utility::utilityType::hygiene)),point::Point(2,10));
        ...
        apartments[0]->getRooms()[2]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default TV",500,75,1,2,furniture::Utility::utilityType::entertaiment)),point::Point(5,9));
        ...
        apartments[0]->getRooms()[2]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Sink",250,75,1,1,furniture::Utility::utilityType::hygiene)),point::Point(10,9));
        apartments[0]->getRooms()[2]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Stove",350,75,1,1,furniture::Utility::utilityType::cooking)),point::Point(10,10));

        apartments[0]->getRooms()[3]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Sink",300,75,1,1,furniture::Utility::utilityType::hygiene)),point::Point(8,0));
        apartments[0]->getRooms()[3]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Toilet",300,75,1,1,furniture::Utility::utilityType::waste)),point::Point(10,0));
        apartments[0]->getRooms()[3]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Bathtub",350,75,2,1,furniture::Utility::utilityType::hygiene)),point::Point(9,3));
        ...
        apartments[0]->getRooms()[4]->addFurniture(std::shared_ptr<furniture::Utility>(new furniture::Utility("Default Desk",250,75,3,1,furniture::Utility::utilityType::entertaiment)),point::Point(8,7));
